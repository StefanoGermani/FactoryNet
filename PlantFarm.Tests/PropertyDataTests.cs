...
namespace Plant.Tests
{
    ...
    public class PropertyDataTests
    {
        ...
        {
            PropertyInfo propInfo = new {Property1 = 3}.GetType().GetProperties()[0];
        ...
        {
            Type type = new {Prop1 = 10, Prop2 = 20}.GetType();
        ...
        {
            var prop1 = new PropertyData(new {Property1 = 3}.GetType().GetProperties()[0]);
            var prop2 = new PropertyData(new {Property1 = 3, Property2 = 4}.GetType().GetProperties()[0]);
                //C# compiler likes to be clever about anonymous types
